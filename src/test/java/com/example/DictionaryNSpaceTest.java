...
public class DictionaryNSpaceTest {
    @Test
    ...
    public void deleteTest(){
        ...
        try {
            ...
            for(int i=0;i<500;i++){
                ...
                assertTrue(dictionary.validateDeletion(keys[randomIndex]));//Check the deleted element if it does not exist, pass
            }
        } catch (Exception e) {
            assumeNoException(e);
        }
    ...
    public void testBatchInsert(){
        ...
        String filePath="C:\\Users\\Cyber\\Desktop\\untitled1\\src\\test\\java\\Words.txt";
